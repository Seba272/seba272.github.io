...
In the 2025 springer semester, I have been teaching a course on Partial Differential Equations (PDE), based on L. C. Evans' "Partial Differential Equations".
...
Since I have been told something may be wrong with the LaTeX, [here is the PDF](/assets/pdf/2025-08-08-IntroductionToPDE.pdf), which is not regularly updated.
...
* [Exercises 10](/assets/pdf/2025-PDE-Exercises-10.pdf) (updated on the 30th of April)
...
* You can find exercises for weeks 11 and 12 in my notes.
...
#### Monday 5/5:
- Sobs: Morrey's inequality
- Sobs: Difference quotients

#### Tuesday 6/5:
- Sobs: Differentiability a.e.
- Sobs: Lipschitz functions
- Sobs: Rellich–Kondrachov compactness theorem

### Week 12

#### Monday 12/5:
- Elli: Intro to second order Elliptic PDE with coefficients in $$L^\infty$$
- Elli: The Sobolev space $$H^1$$
- Sobs: Poincaré inequality in $$W^{1,p}_0(\Omega)$$
- Elli: A scalar product on $$H^1_0$$ and solutions to Elliptic PDE
- Elli: Dirichlet form associated to an Elliptic PDE
- Elli: Statement of Lax–Milgram Theorem 
- Elli: First Existence and Uniqueness result 

#### Tuesday 13/5:
- Elli: Statement of Fredholm Alternative Theorem 
- Elli: Second Existence and Uniqueness result
- Elli: Caccioppoli Inequality
- Elli: Regularity of solutions to Elliptic PDE
